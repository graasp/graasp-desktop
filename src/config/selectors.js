...
export const FAVORITE_SPACES_MAIN_ID = 'favoriteSpacesMain';
...
export const SETTINGS_MAIN_ID = 'settings';
export const VISIT_INPUT_ID = 'visitInput';
export const VISIT_BUTTON_ID = 'visitButton';
export const SPACE_TOOLBAR_ID = 'spaceToolbar';
export const HOME_MENU_ITEM_ID = 'homeMenuItem';
export const HOME_MAIN_ID = 'homeMain';
export const DASHBOARD_MENU_ITEM_ID = 'dashboardMenuItem';
