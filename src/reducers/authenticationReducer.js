...
export const DEFAULT_USER_SETTINGS = {
  ...
  syncAdvancedMode: DEFAULT_SYNC_ADVANCED_MODE,
};
...
export default (state = INITIAL_STATE, { type, payload }) => {
  switch (type) {
    ...
    case FLAG_SETTING_SYNC_ADVANCED_MODE:
    case FLAG_GETTING_SYNC_ADVANCED_MODE:
    ...
    case SET_SYNC_ADVANCED_MODE_SUCCEEDED:
    case GET_SYNC_ADVANCED_MODE_SUCCEEDED:
      return state.setIn(['user', 'settings', 'syncAdvancedMode'], payload);
    default:
      return state;
  }
};
